...
clear
toilet --filter border MasTerSv RK | lolcat
echo
echo -e "$purple(*)$blue MasTerSv Rk$Cafe v2.5$blue"
sleep 2
...
sleep 5
curl https://raw.githubusercontent.com/drandroidsv/Mastersv-Rk/master/masterrk.sh > masterrk.sh
